...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-sept5-test](https://github.com/jdubrick-ai/test-sept5-test)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-sept5-test-gitops](https://github.com/jdubrick-ai/test-sept5-test-gitops)

# **Usage**

To access the test-sept5-test application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of test-sept5-test. You can access this namespace through the web console or via your CLI.
