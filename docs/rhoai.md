...
2) Go to the `Data Science Projects` section and access your application's project named `test-sept5-test`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `test-sept5-test-notebook`.
...
5) In the terminal, run `cd test-sept5-test` to navigate to your sample app's directory.
